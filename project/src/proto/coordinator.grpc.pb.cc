...
static const char* coordinatorService_method_names[] = {
  ...
  "/coordinator_proto.coordinatorService/getBlocksOnNodes",
...
coordinatorService::Stub::Stub(const std::shared_ptr< ::grpc::ChannelInterface>& channel, const ::grpc::StubOptions& options)
  ...
  , rpcmethod_getBlocksOnNodes_(coordinatorService_method_names[20], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  ...
  , rpcmethod_mergeStripes_(coordinatorService_method_names[23], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
...
::grpc::Status coordinatorService::Stub::getBlocksOnNodes(::grpc::ClientContext* context, const ::coordinator_proto::NodeIdsFromClient& request, ::coordinator_proto::NodesPlacementReply* response) {
  return ::grpc::internal::BlockingUnaryCall< ::coordinator_proto::NodeIdsFromClient, ::coordinator_proto::NodesPlacementReply, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(channel_.get(), rpcmethod_getBlocksOnNodes_, context, request, response);
}

void coordinatorService::Stub::async::getBlocksOnNodes(::grpc::ClientContext* context, const ::coordinator_proto::NodeIdsFromClient* request, ::coordinator_proto::NodesPlacementReply* response, std::function<void(::grpc::Status)> f) {
  ::grpc::internal::CallbackUnaryCall< ::coordinator_proto::NodeIdsFromClient, ::coordinator_proto::NodesPlacementReply, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(stub_->channel_.get(), stub_->rpcmethod_getBlocksOnNodes_, context, request, response, std::move(f));
}

void coordinatorService::Stub::async::getBlocksOnNodes(::grpc::ClientContext* context, const ::coordinator_proto::NodeIdsFromClient* request, ::coordinator_proto::NodesPlacementReply* response, ::grpc::ClientUnaryReactor* reactor) {
  ::grpc::internal::ClientCallbackUnaryFactory::Create< ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(stub_->channel_.get(), stub_->rpcmethod_getBlocksOnNodes_, context, request, response, reactor);
}

::grpc::ClientAsyncResponseReader< ::coordinator_proto::NodesPlacementReply>* coordinatorService::Stub::PrepareAsyncgetBlocksOnNodesRaw(::grpc::ClientContext* context, const ::coordinator_proto::NodeIdsFromClient& request, ::grpc::CompletionQueue* cq) {
  return ::grpc::internal::ClientAsyncResponseReaderHelper::Create< ::coordinator_proto::NodesPlacementReply, ::coordinator_proto::NodeIdsFromClient, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(channel_.get(), cq, rpcmethod_getBlocksOnNodes_, context, request);
}

::grpc::ClientAsyncResponseReader< ::coordinator_proto::NodesPlacementReply>* coordinatorService::Stub::AsyncgetBlocksOnNodesRaw(::grpc::ClientContext* context, const ::coordinator_proto::NodeIdsFromClient& request, ::grpc::CompletionQueue* cq) {
  auto* result =
    this->PrepareAsyncgetBlocksOnNodesRaw(context, request, cq);
  result->StartCall();
  return result;
}
...
coordinatorService::Service::Service() {
  ...
  AddMethod(new ::grpc::internal::RpcServiceMethod(
      ...
      ::grpc::internal::RpcMethod::NORMAL_RPC,
      new ::grpc::internal::RpcMethodHandler< coordinatorService::Service, ::coordinator_proto::NodeIdsFromClient, ::coordinator_proto::NodesPlacementReply, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(
          [](coordinatorService::Service* service,
             ::grpc::ServerContext* ctx,
             const ::coordinator_proto::NodeIdsFromClient* req,
             ::coordinator_proto::NodesPlacementReply* resp) {
               return service->getBlocksOnNodes(ctx, req, resp);
             }, this)));
  AddMethod(new ::grpc::internal::RpcServiceMethod(
...
::grpc::Status coordinatorService::Service::getBlocksOnNodes(::grpc::ServerContext* context, const ::coordinator_proto::NodeIdsFromClient* request, ::coordinator_proto::NodesPlacementReply* response) {
  (void) context;
  (void) request;
  (void) response;
  return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
