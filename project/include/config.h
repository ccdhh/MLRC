...
namespace ECProject
{
   ...
   * Must stay below PROXY_PIPELINE_EXCHANGE_BASE and below the OS ephemeral range
   * (typically 32768+) so outbound TCP sockets cannot steal planned listener ports.
   */
